...
from landingai.pipelines.base import collate_fn
from landingai.utils.constant import ModelFile
from landingai.utils.logger import get_logger
from landingai.utils.regress_test_utils import (compare_arguments_nested,
...
class TorchModelExporter(Exporter):
    ...
    def _validate_onnx_model(self,
        ...
        elif isinstance(outputs_origin, (tuple, list, torch.Tensor)):
